...
public final class ConstantesMetier {
    ...
    public static final String REPAS_CONSTRUCTION_EXCEPTION = "Echec lors de la creation du repas.";
    public static final String PATIENT_CONSTRUCTION_EXCEPTION = "Echec lors de la creation du patient.";
