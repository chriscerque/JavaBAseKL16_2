...
public class FacadeMetierImpl implements FacadeMetier {
    RepasMemDao repasDao = (RepasMemDao) DaoFactory.fabriquerRepasDao();
    PatientMemDao patientDao = (PatientMemDao) DaoFactory.fabriquerPatientDao();
    /**
     ...
     */
    @Override
    public Patient sauvegarderPatient(Patient patient) throws BusinessException {
    ...
    public void supprimerPatient(Patient patient) throws BusinessException {
        if(Objects.isNull(patient)){
            throw new BusinessException(ConstantesMetier.MSG_DAO_SUPPRESSION_PATIENT_NULL);
        }
        try {
     ...
     */
    @Override
    public Patient mettreAJourPatient(Patient patient) throws BusinessException {
        if(Objects.isNull(patient)){
            throw new BusinessException(ConstantesMetier.MSG_DAO_MISE_A_JOUR_PATIENT_NULL);
        }
        try {
