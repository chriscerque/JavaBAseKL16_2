...
import net.ent.etrs.repaspatient.model.dao.ConstantesDao;
import net.ent.etrs.repaspatient.model.dao.IPatientMemDao;
import net.ent.etrs.repaspatient.model.dao.IRepasMemDao;
...
public class FacadeMetierImpl implements FacadeMetier{
    ...
    public void sauvegarderPatient(Patient patient) throws BusinessException {
        try {
            ...
            throw new BusinessException(ConstantesDao.DAO_PATIENT_EXIST_EXCEPTION);
        }
    }
    ...
    public void supprimerPatient(Patient patient) throws BusinessException {
        try {
            ...
            throw new BusinessException(ConstantesDao.DAO_PATIENT_EXIST_PAS_EXCEPTION);
        }
    }
    ...
    public void mettreAJourPatient(Patient patient) throws BusinessException {
        try {
            ...
            throw new BusinessException(ConstantesDao.DAO_PATIENT_EXIST_NULL_EXCEPTION);
        }
    }
