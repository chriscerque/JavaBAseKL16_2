package net.ent.etrs.repaspatient.commons.utils;
...
public final class AffichageConsole {
    ...
    /**
     * Permet d'afficher un Set en Tableau
     * @param options Set de chaînes de caractères à traiter.
     */
    public static void afficherMenuSimpleSansChoix(final Set<String> options){
