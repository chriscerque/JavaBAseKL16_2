...
public final class ConstantesMetier {
    ...
    public static final String REPAS_VIDE = "Le repas est nul";
    public static final String REGIME_ALIMENTAIRE_VIDE = "Le regime alimentaire entré est nul";
    public static final String DAO_REPAS_INEXISTANT = "Le repas n'existe pas";
    public static final String DAO_PATIENT_INEXISTANT = "Le patient n'existe pas";
