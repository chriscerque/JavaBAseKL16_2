...
public class FacadeMetierImpl implements FacadeMetier{
    ...
    @Override
    public void supprimerPatient(Patient patient) throws BusinessException, DaoException {
    ...
    public Patient recupererPatientById(String patientId) throws BusinessException, DaoException {
        ...
        public void init() throws BusinessException {
            ...
            } catch (DaoException | RegimeAlimentaireException e) {
...
//            miney.ajouterRegimeAlimentaire(RegimeAlimentaire.VEGAN);
            ...
            } catch (DaoException | RegimeAlimentaireException | RepasException | PatientConstructionException e) {
                throw new BusinessException(e.getMessage(), e);
            }
