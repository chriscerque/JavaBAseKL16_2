...
public final class ConstantesVue {
    ...
    public static final String SAISIR_NUMERO_DE_SECURITE= "Veuillez saisir votre numéro de sécurité social :";
    public static final String SAISIR_NOM= "Veuillez saisir votre nom :";
    public static final String SAISIR_PRENOM= "Veuillez saisir votre prénom :";
    ...
    public static final String MSG_PATIENT_NON_SUPPRIMEE = "Le patient %s %s a été supprimé.";
