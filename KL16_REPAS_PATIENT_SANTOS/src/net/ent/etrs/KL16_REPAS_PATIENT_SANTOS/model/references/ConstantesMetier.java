...
public final class ConstantesMetier {
    ...
    public static final String REPAS_CONSTRUCTION_EXCEPTION = "Erreur lors de la création du repas";
    public static final String DAO_PATIENT_IMPOSSIBLE_CREATE = "Impossible de créer le patient";
    public static final String MSG_DAO_SUPPRESSION_REPAS_NULL = " le repas n'a pas pu etre supprimé" ;
    public static final String FACADE_METIER_PATIENT_DELETE_IMPOSSIBLE = "Impossible de suprpimer le patient ";
    public static final String FACADE_METIER_PATIENT_NULL =" crééer patient face Null "  ;
    public static final String FACADE_METIER_MAJ_PATIENT_NULL ="Erreur mis a jour patient" ;
    public static final String FACADE_METIER_PATIENT_NON_CREE = "Patient erreur facade non créer";
    public static final String FACADE_VIEW_PATIENT_NULL = "aucun patient a afficher ";
    public static final String FACADE_VIEW_REPAS = "Pas de repas a afficher ";
    public static String FACADE_METIER_METIEr_PATIENT_NULL = "Facade Metier Suppression Null";
