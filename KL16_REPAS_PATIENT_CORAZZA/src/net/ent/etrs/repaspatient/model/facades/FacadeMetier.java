...
public interface FacadeMetier {
     ...
     */
    void sauvegarderPatient(Patient patient) throws BusinessException, PatientException;
     ...
     */
    void mettreAJourPatient(Patient patient) throws BusinessException, PatientException;
