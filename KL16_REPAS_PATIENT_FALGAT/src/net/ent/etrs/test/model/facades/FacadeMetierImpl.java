...
import net.ent.etrs.test.model.daos.DaoFactory;
import net.ent.etrs.test.model.daos.IPatientMemDao;
import net.ent.etrs.test.model.daos.IRepasMemDao;
...
public class FacadeMetierImpl implements FacadeMetier{
    ...
    @Override
    public List<Patient> listerPatients() throws BusinessException {
        try {
    ...
    @Override
    public List<Repas> listerRepas() throws BusinessException {
        try {
