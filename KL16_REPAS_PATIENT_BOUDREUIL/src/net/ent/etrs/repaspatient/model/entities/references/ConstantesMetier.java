...
public final class ConstantesMetier {
    ...
    public static final String MSG_PATIENT_REPAS_VIDE_EXCEPTION = "Aucun repas";
    public static final String MSG_PATIENT_REGIME_ALIMENTAIRE_VIDE_EXCEPTION = "Aucun régime alimentaire";
    ...
    public static final String MSG_CONSTRUCTION_PATIENT_EXCEPTION = "Echec construction patient";
    public static final String MSG_CONSTRUCTION_REPAS_EXCEPTION = "Echec construction repas";
    ...
    public static final String MSG_DAO_PATIENT_INEXISTANT = "Dao : le patient n'existe pas";

    //DAO REPAS
    public static final String MSG_DAO_REPAS_INEXISTANT = "Dao : le repas n'existe pas";
    ...
    public static final String MSG_DAO_SUPPRESSION_REPAS_NULL = "Dao : tentative de suppression d'un repas a null";
    public static final String MSG_DAO_MODIF_REPAS_INEXISTANT = "Dao : tentative de modification d'un repas inexistant";
