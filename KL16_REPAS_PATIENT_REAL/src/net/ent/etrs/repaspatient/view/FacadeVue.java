...
public interface FacadeVue {
     ...
     * @return
     */
    List<Patient> afficherPatients(List<Patient> lstPatients) throws ViewException;
     ...
     */
    Patient saisirPatient() throws ViewException, RegimeAlimentaireException;
     ...
     */
    Patient selectionnerPatient(List<Patient> lstPatients) throws BusinessException;
...
//    void afficherRepas(Patient c);
     ...
     */
    List<Repas> selectionnerRepas(List<Repas> lstRepas) throws BusinessException;
