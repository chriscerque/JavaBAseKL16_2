...
import net.ent.etrs.repaspatient.model.daos.IRepasMemsDao;
...
public class FacadeMetierImpl implements FacadeMetier{
    ...
    IPatientMemDao patientDao = DaoFactory.fabriquerPatientDao();
    IRepasMemsDao repasDao = DaoFactory.fabriquerRepasDao();
    ...
    @Override
    public void sauvegarderPatient(Patient patient) throws BusinessException, DaoException {
        patientDao.create(patient);
        patientDao.update(patient);
    }

    @Override
    public void supprimerPatient(String numSecu) throws BusinessException {
        patientDao.delete(numSecu);
    }

    @Override
    public void mettreAJourPatient(Patient patient) throws BusinessException, DaoException {
        patientDao.update(patient);
    }
...
//            miney.ajouterRegimeAlimentaire(RegimeAlimentaire.VEGAN);
    ...
    @Override
    public Patient recupererPatientById(String patientId) throws BusinessException, DaoException {
        Patient p = null;

        return p = patientDao.read(patientId);
    }

//    @Override
//    public Patient selectionnerPatient(List<Patient> patients) throws BusinessException {
//        if(patients.size() == 0){
//            throw new BusinessException(ConstantesMetier.MSG_DAO_PERSITANCE_PATIENT_NULL);
//        }
//        List<String> lstPatientTemp = new ArrayList<>();
//        for (Patient pat : patients) {
//            lstPatientTemp.add(pat.toString());
//        }
