...
public class FacadeMetierImpl implements FacadeMetier {
    ...
    public void sauvegarderPatient(final Patient patient) throws BusinessException {
        try {
            ...
            throw new BusinessException(String.format(ConstantesMetier.MSG_PATIENT_CREATION_EXCEPTION, patient.getNom(), patient.getPrenom()), e);
        }
    ...
    public void supprimerPatient(final Patient patient) throws BusinessException {
        try {
            ...
            throw new BusinessException(String.format(ConstantesMetier.MSG_PATIENT_SUPPRESSION_EXCEPTION, patient.getNom(), patient.getPrenom()), e);
        }
    ...
    public void mettreAJourPatient(final Patient patient) throws BusinessException {
        try {
            ...
            throw new BusinessException(String.format(ConstantesMetier.MSG_PATIENT_MISE_A_JOUR_EXCEPTION, patient.getNom(), patient.getPrenom()), e);
        }
