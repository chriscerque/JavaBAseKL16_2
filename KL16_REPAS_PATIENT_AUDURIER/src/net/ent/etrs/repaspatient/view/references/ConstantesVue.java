...
public final class ConstantesVue {
    ...
    public static final String SAISIR_NUM_SECU_MSG = String.format(SAISIR_TYPE_MSG, "numéro de sécurité");
    public static final String SAISIR_NOM_MSG = String.format(SAISIR_TYPE_MSG, "nom");
    public static final String SAISIR_PRENOM_MSG = String.format(SAISIR_TYPE_MSG, "prénom");
    ...
    public static final String NULL_EXCEPTION = "Valeur non renseignée";
