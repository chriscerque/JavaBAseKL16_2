...
public final class ConstantesMetier {
    ...
    public static final String MSG_PATIENT_VIDE_EXCEPTION = "Aucun paramètre renseigné";
    ...
    public static final String REPAS_REGIME_ALIMENATIRE_EXCEPTION = "Regime non renseigné";
    public static final String REPAS_REGIME_ALIMENATIRE_EXISTE_DEJA_EXCEPTION = "Régime déja existant";
    public static final String REPAS_CONSTRUCTION_EXCEPTION = "Erreur construction repas";
    public static final String PATIENT_REPAS_INVALIDE = "Le repas ne correspond pas au régime alimentaire du patient";
    public static final String PATIENT_CONSTRUCTION_EXCEPTION = "Création patient impossible";
