...
public final class ConstantesMetier {
    ...
    public static final String MSG_DAO_MISE_A_JOUR_REPAS_INEXISTANT = "Dao : tentative de modification d'un repas inexistant";
    public static final String MSG_DAO_LECTURE_REPAS_NULL = "Dao : tentative de lecture d'un repas à null";
    public static final String MSG_DAO_LECTURE_REPAS_INEXISTANT = "Dao : tentative de lecture d'un repas inexistant";
    //PRESENTER
    public static final String TITRE_MENU_PRINCIPAL = "Repas patient";
    public static final String[] OPTIONS_MENU_PRINCIPAL = {"Lister les patients",
                                                           "Créer un nouveau patient",
                                                           "Modifier un patient",
                                                           "Supprimer un patient",
                                                           "Ajouter un repas a un patient"};
    public static final int NB_OPTION_MENU_PRINCIPAL = 5;
    public static final String CHOIX_OPTION_MENU_PRINCIPAL = "Veuillez choisir une option:";
    //VUE
    public static final String VUE_MSG_SAISIE_NSS = "Veuillez renseigner le numéro de sécurité sociale du patient";
    public static final String VUE_MSG_SAISIE_NOM = "Veuillez renseigner le nom du patient";
    public static final String VUE_MSG_SAISIE_PRENOM = "Veuillez renseigner le prénom du patient";
    public static final String VUE_MSG_SAISIE_REPAS = "Veuillez choisir un repas";
    public static final String VUE_MSG_SAISIE_REPAS_SUIVANT = "Ajouter un autre repas?";
