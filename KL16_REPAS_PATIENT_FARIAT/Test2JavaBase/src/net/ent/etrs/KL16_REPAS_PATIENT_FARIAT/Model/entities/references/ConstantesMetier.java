...
public final class ConstantesMetier {
    ...
    public static final String AJOUT_REGIME_ALIMENTAIRE_NULL = "Veuillez saisir l'ajout du regime alimentaire";
    public static final String REPAS_NULL = "Veuillez ajouter un repas a nouveau";
    public static final String REGIME_ALIMENTAIRE_NULL = "Veuillez ajouter le regime alimentaire a nouveau";
    public static final String TYPE_REPAS_NULL = "Type repas vide";
