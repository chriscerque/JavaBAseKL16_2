package net.ent.etrs.KL16_REPAS_PATIENT_FARIAT.views.references;
...
public final class ConstantesView {
    ...
    public static final String FACADE_VIEW_LIST_REPAS_VIDE = "Liste repas vide";
    public static final String FACADE_VIEW_LIST_PATIENT_VIDE = "Liste patient vide";
    public static final String AFFICHER_MSG_NUM_SECU = "Saisir num secu";
    public static final String AFFICHER_MSG_NOM = "Veuillez saisir nom";
    public static final String AFFICHER_MSG_PRENOM = "Veuillez saisir prenom";
