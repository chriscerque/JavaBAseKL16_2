...
public final class ConstantesMetier {
    ...
    public static final String MSG_CONSTRUCTION_REPAS = "Une erreur est survenue lors de la création du repas.";
    public static final String MSG_CONSTRUCTION_PATIENT = "Une erreur est survenue lors de la création du patient.";
    public static final String PATIENT_REPAS_REGIME_ALIMENTAIRE_EXIST_EXCEPTION ="le repas du patient existe déjà" ;
