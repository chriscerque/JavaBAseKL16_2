...
public class RepasMemDao implements IRepasMemDao{
    ...
    public Repas update(Repas Repas) throws DaoException {
        ...
        Repas repas = persistence.set(persistence.indexOf(Repas), Repas);
    ...
    public void delete(Repas repas) throws DaoException {
        ...
        List<Repas> listeRepasTemporaire = new ArrayList<>(persistence);

        for (Repas r : listeRepasTemporaire) {
            if (repas.getId().equals(repas)) {
