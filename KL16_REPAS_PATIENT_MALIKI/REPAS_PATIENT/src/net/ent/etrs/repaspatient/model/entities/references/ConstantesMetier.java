...
public final class ConstantesMetier {
    ...
    public static final String MSG_REGIME_ALIMENTAIRE_NON_TROUVE_EXCEPTION = "le regime alimentaire specifié n'a pas ete trouvé";
    public static final String REPAS_REGIME_ALIMENTAIRE_EXCEPTION = "le regime alimentaire doit etre renseigné";
    public static final String REPAS_REGIME_ALIMENTAIRE_EXIST_EXCEPTION = "le regime alimentaire existe deja";
    public static final String REPAS_CONSTRUCTION_ERROR_EXCEPTION = "impossible de constituer le repas";
    public static final String PATIENT_REPAS_NULL_EXCEPTION
            = "Le repas doit etre renseigné";
    public static final String PATIENT_REPAS_EXIST_EXCEPTION = "le repas existe deja";
    public static final String PATIENT_REPAS_REGIME_NULL_EXCEPTION = "le regime doit etre renseigné";
    public static final String PATIENT_REGIME_ALIMENTAIRE_EXIST_EXCEPTION = "le regime alimentaire existe deja";
    public static final String PATIENT_CONSTRUCTION_ERROR = "impossible de creer le patient";
    public static final String DAO_REPAS_MISE_A_JOUR_IMPOSSIBLE = "impossible de mettre a jour le repas";
    public static final String DAO_REPAS_EXIST_NULL_EXCEPTON = "Une erreure est survenue lors de la recherche du repas.";
    public static final String DAO_PATIENT_EXIST_NULL_EXCEPTON = "Une erreure est survenue lors de la recherche " +
            "du patient.";
    public static final String FACADE_METIER_PATIENT_NULL = "Le patient doit etre renseigné";
    public static final String FACADE_VIEW_LIST_PATIENTS_VIDE = "la liste des patients est vide";
